...
Before export work resumes, the remaining blockers are manuscript-body approval, final Figure 1 and Figure 2 direction, final bibliography formatting, a clean reproduction transcript or explicit deferral, table and algorithm layout review, source-package hygiene review, and final arXiv category/license/human approval. This manuscript draft should therefore be treated as a v0.8 citation-cleanup text draft, not as a submission package.
...
|---|---|---|
| Manuscript draft | `docs/paper/kora-first-paper-manuscript-v0-8.md` | Current Word-first citation-cleanup text draft, not final |
...
This preliminary references section uses manuscript-cited records that are currently present in preliminary BibTeX. Manuscript v0.8 preserves the aligned v0.7 cited record set and keeps optional, deferred, and still-not-eligible records out of the draft. Citation style and BibTeX are not final. See [KORA First Paper Manuscript Bibliography Sync v0.1](kora-first-paper-manuscript-bibliography-sync-v0-1.md), [KORA First Paper Citation Audit v0.1](kora-first-paper-citation-audit-v0-1.md), and [KORA First Paper v0.8 Citation Cleanup Delta](kora-first-paper-v0-8-citation-cleanup-delta.md) for citation consistency, traceability, and claim-boundary notes.
