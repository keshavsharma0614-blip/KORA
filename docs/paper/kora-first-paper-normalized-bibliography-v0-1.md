...
- [KORA First Paper Final Blocked Metadata Review v0.1](kora-first-paper-final-blocked-metadata-review-v0-1.md) consolidates candidate, deferred, and still-blocked status for remaining blocked records before any expanded BibTeX preparation.
...
- No BibTeX is generated by the final blocked metadata review.
...
Final blocked metadata review candidate set after final field check:

- `[R03]`, `[R04]`, `[R05]`, `[R07]`, `[R09]`, `[R10]`, `[R12]`, `[R13]`, `[R16]`

Final blocked metadata review deferred or still-blocked set:

- deferred until target venue selection: `[R17]`, `[R18]`
- still not eligible until author-list, split, or venue/style decision: `[R02]`, `[R15]`, `[R19]`, `[R20]`, `[R22]`, `[R23]`
