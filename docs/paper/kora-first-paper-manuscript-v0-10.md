...
Draft reviewed asset references:

- SVG source: `../assets/paper/kora-first-paper-figure-1-v0-9-draft.svg`
- PNG rendering: `../assets/paper/kora-first-paper-figure-1-v0-9-draft.png`

Draft status: reviewed draft asset for manuscript-body review and later insertion testing. This is not final publication layout. Word/PDF/arXiv/export work remains paused.
...
- SVG source: `../assets/paper/kora-first-paper-figure-2-v0-9-draft.svg`
- PNG rendering: `../assets/paper/kora-first-paper-figure-2-v0-9-draft.png`

Draft status: reviewed draft asset for manuscript-body review and later insertion testing. This is not final publication layout. Word/PDF/arXiv/export work remains paused.

Caption: In a reproducible 100-task deterministic-heavy benchmark workload, KORA-controlled execution avoided 80 of 100 simulated model invocations versus a naive direct baseline. The direct baseline counts 100 simulated model invocations; KORA-controlled execution records 20 simulated model invocations and 80 avoided simulated model invocations in this workload. This does not imply real API calls, production traffic, production cost savings, latency improvement, energy reduction, or broad workload superiority.
...
- Figure 1 and Figure 2 use reviewed draft asset references only until final publication-quality figure layout is approved after manuscript-body review
...
This manuscript draft is based on reproducible benchmark and local/no-network validation evidence. Manuscript v0.10 applies the reviewed draft Figure 1 and Figure 2 asset references while preserving the v0.9 cited record set for working review. It does not add references, does not apply manual/external-verification items, does not apply final-packaging/export deferrals, does not apply keep-excluded/do-not-add records, does not finalize bibliography style, and does not use external citations as evidence for KORA benchmark results. It does not claim production cost reduction, real API-cost reduction, energy reduction, production validation, broad workload superiority, formal artifact evaluation, or superiority over cited systems. Figure 1 and Figure 2 use reviewed draft asset references only; final publication layout, Word/PDF/arXiv/export work, and final figure approval remain pending.
